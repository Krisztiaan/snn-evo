...
class RandomAgent:
    ...
    def _run_one_episode(self, exporter: DataExporter, episode_num: int, key: random.PRNGKey) -> Dict[str, Any]:
        ...
        exporter.log_static_episode_data("world_setup", {"reward_positions": np.array(state.reward_positions)})
