...
class NetworkParams(NamedTuple):
    ...
    HOMEOSTATIC_TAU: float = 10000.0  # Slow adaptation (10s)
    THRESHOLD_ADAPT_RATE: float = 0.0001  # Conservative adaptation
    ...
    TAU_ELIGIBILITY: float = 1000.0    # Eligibility trace decay (1s)
    TAU_DOPAMINE: float = 200.0        # Dopamine decay (200ms)
    ...
    BASE_LEARNING_RATE: float = 0.01   # Conservative learning rate
    WEIGHT_DECAY: float = 1e-5         # Prevent weight explosion
    MAX_WEIGHT_SCALE: float = 2.0      # Soft bounds via tanh
    
    # Reward prediction  
    REWARD_PREDICTION_RATE: float = 0.01  # TD learning rate
    ...
    LEARN_INPUT_CONNECTIONS: bool = False     # Fixed input (important!)
