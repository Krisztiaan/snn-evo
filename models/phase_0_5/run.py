...
def main():
    parser = argparse.ArgumentParser(description="Run Phase 0.5 SNN Agent Experiments")
    parser.add_argument("--episodes", type=int, default=1, help="Number of episodes to run")
    parser.add_argument("--steps", type=int, default=10000, help="Max steps per episode")
    parser.add_argument("--seed", type=int, default=42, help="Master random seed")
    parser.add_argument(
        "--export-dir", type=str, default="experiments/phase_0_5", help="Directory for data export"
    )
