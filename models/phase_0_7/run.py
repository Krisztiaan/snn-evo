# keywords: [snn run, experiment runner, phase 0.7]
"""Main script to run Phase 0.7 SNN agent experiments."""
...
def main():
    parser = argparse.ArgumentParser(description="Run Phase 0.7 SNN Agent Experiments")
    parser.add_argument("--episodes", type=int, default=3, help="Number of episodes to run")
    parser.add_argument("--steps", type=int, default=10000, help="Max steps per episode")
    parser.add_argument("--seed", type=int, default=42, help="Master random seed")
    parser.add_argument("--export-dir", type=str, default="experiments/phase_0_7", help="Directory for data export")
    ...
    config = SnnAgentConfig(world_config=world_config, network_params=network_params, exp_config=exp_config)

    if not args.no_export:
        Path(args.export_dir).mkdir(parents=True, exist_ok=True)

    print("🚀 Starting Phase 0.7 SNN Experiment")
    print("=" * 40)
