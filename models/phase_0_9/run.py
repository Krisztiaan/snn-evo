# models/phase_0_9/run.py
# keywords: [snn run, experiment runner, phase 0.9, gradient dopamine]
"""Main script to run Phase 0.9 SNN agent experiments with gradient-based dopamine."""
...
def main():
    parser = argparse.ArgumentParser(
        description="Run Phase 0.9 SNN Agent - Gradient-Based Dopamine",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Phase 0.9 enhances learning speed with gradient-proportional dopamine:
- Dopamine reward proportional to gradient value
- Faster reinforcement of gradient-following behavior
...
- Biologically motivated connectivity
    ...
    parser.add_argument(
        "--episodes", type=int, default=3, help="Number of episodes to run (default: 3)"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--export-dir",
        type=str,
        default="experiments/phase_0_9",
        help="Directory for data export (default: experiments/phase_0_9)",
    )
    parser.add_argument(
