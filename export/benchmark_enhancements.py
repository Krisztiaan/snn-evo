        ...
        with DataExporter(
            ...
            **config
            ...
            exporter.save_network_structure(
                ...
                {"sources": np.arange(n_neurons//2), "targets": np.arange(n_neurons//2, n_neurons)}
            )
            ...
            stats = exporter.get_performance_stats() if hasattr(exporter, 'get_performance_stats') else {}
...
if __name__ == "__main__":
    ...
    for config_name in ["Async Writes (4 workers)", "Adaptive Compression", "All Enhancements", "Ultra Performance"]:
