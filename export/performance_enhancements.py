...
class AdaptiveCompressor:
    ...
    def select_compression(self, data: np.ndarray, speed_priority: float = 0.5) -> Tuple[str, int]:
    ...
    def update_stats(
        self, algorithm: str, original_size: int, compressed_size: int, compression_time: float
    ):
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            return {
                ...
                "overall_throughput_mbps": (self.total_bytes / (1024 * 1024)) / elapsed_time
                if elapsed_time > 0
                else 0,
                "recent_throughput_mbps": (recent_total_bytes / (1024 * 1024)) / recent_total_time
                if recent_total_time > 0
                else 0,
...
class PerformanceProfiler:
    ...
    def print_report(self):
        ...
        print("\n=== Performance Report ===")
        print(
            f"{'Operation':<30} {'Count':>10} {'Avg(ms)':>10} {'Min(ms)':>10} {'Max(ms)':>10} {'MB/s':>10}"
        )
        print("-" * 80)
