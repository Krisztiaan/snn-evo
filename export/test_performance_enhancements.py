    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        with DataExporter(
            ...
            with exporter.start_episode(0) as episode:
                ...
                episode.log_timestep(
                    timestep=0,
                    neural_state={"sparse": sparse_data}
                )
                ...
                episode.log_timestep(
                    timestep=1,
                    neural_state={"random": random_data}
                )
                ...
                episode.log_timestep(
                    timestep=2,
                    neural_state={"repetitive": repetitive_data}
                )
        ...
        with DataExporter(
            ...
            with exporter.start_episode(0) as episode:
                ...
                for t in range(1000):
                    episode.log_timestep(
                        timestep=t,
                        neural_state={"data": np.random.randn(500)}
                    )
                    ...
                    if t > 0 and t % 100 == 0:
                        if episode.realtime_stats:
                            ...
                            print(f"  Timestep {t}: {stats['recent_throughput_mbps']:.1f} MB/s, "
